...
export const seedData: StoredData = {
  ...
  users: [
    ...
    {
      uid: "equipo-campo-01",
      nombre: "Equipo Campo 01",
      email: "equipo01@nextglass.com",
      role: "equipo_campo",
      active: true,
      phone: "",
      assignedWorkIds: ["obra-palmanova"],
      assignedTeamIds: ["equipo-campo-01"],
      teamName: "Equipo Campo 01",
      teamType: "equipo_campo",
  ...
  tareas: [
    {
      id: "tarea-pal-vidrios-norte",
      obraId: "obra-palmanova",
      obraNombre: "Residencias Palmanova",
      titulo: "Instalar vidrios fachada norte",
      descripcion: "Avanzar con paños liberados de fachada norte.",
      rubroId: "rubrica-pal-vidrios",
      rubroNombre: "Vidrios instalados",
      cantidadPrevista: 32,
      unidad: "m2",
      fechaAsignada: "2026-06-06",
      fechaLimite: "2026-06-07",
      asignadoAType: "equipo_campo",
      asignadoAId: "equipo-campo-01",
      asignadoANombre: "Equipo Campo 01",
      fiscalizadorId: "sup-hugo",
      fiscalizadorNombre: "Hugo Franco",
      estado: "asignada",
      requiereFotos: true,
    ...
    {
      id: "tarea-pal-sellado",
      obraId: "obra-palmanova",
      obraNombre: "Residencias Palmanova",
      titulo: "Sellado de remates sector B",
      descripcion: "Reportar metros ejecutados y observaciones.",
      rubroId: "rubrica-pal-sellado",
      rubroNombre: "Sellado final",
      cantidadPrevista: 18,
      unidad: "m2",
      fechaAsignada: "2026-06-06",
      ...
      requiereFotos: true,
      requiereValidacion: true,
      cantidadReportada: 12,
      observacionCampo: "Sector B avanzado, faltan remates por lluvia.",
      fotos: [],
      createdAt: now,
      updatedAt: "2026-06-06T11:30:00.000Z",
      createdBy: "demo-admin",
      updatedBy: "equipo-campo-01"
    },
    {
      id: "tarea-aur-relevamiento",
      obraId: "obra-aurora",
      obraNombre: "Edificio Aurora",
      titulo: "Relevar contramarcos pendientes",
      descripcion: "Controlar cantidades y cargar fotos.",
      rubroNombre: "Contramarcos",
      fechaAsignada: "2026-06-06",
      asignadoAType: "fiscalizador",
      asignadoAId: "sup-andrea",
      asignadoANombre: "Andrea Ruiz",
      fiscalizadorId: "sup-andrea",
      fiscalizadorNombre: "Andrea Ruiz",
      estado: "pendiente",
      requiereFotos: false,
      requiereValidacion: true,
      fotos: [],
  ...
  jornadasCampo: [
    {
      id: "jornada-pal-20260606",
      obraId: "obra-palmanova",
      obraNombre: "Residencias Palmanova",
      equipoId: "equipo-campo-01",
      equipoNombre: "Equipo Campo 01",
      userId: "equipo-campo-01",
      userName: "Equipo Campo 01",
      fecha: "2026-06-06",
      horaInicio: "08:04",
      ubicacionInicio: {
        lat: -25.2968,
      ...
      ubicacionInicioDisponible: true,
      estado: "activa",
      tareasIds: ["tarea-pal-vidrios-norte", "tarea-pal-sellado"],
      fotosInicio: [],
      fotosAvance: [],
      fotosFin: [],
