...
export const navigationItems = [
  ...
  { label: "Cheques",         path: "/cheques",             icon: Landmark,         animClass: "icon-cobros"        },
  { label: "Tareas",          path: "/tareas",              icon: ClipboardList,    animClass: "icon-avance"        },
  { label: "Instalaciones",   path: "/instalaciones",       icon: Truck,            animClass: "icon-instalaciones" },
